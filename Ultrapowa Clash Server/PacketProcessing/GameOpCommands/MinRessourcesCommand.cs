    ...
    internal class MinRessourcesCommand : GameOpCommand
    {
        ...
        public override void Execute(Level level)
        {
            if (level.GetAccountPrivileges() >= GetRequiredAccountPrivileges())
            {
                ...
                p.SetResourceCount(ObjectManager.DataTables.GetResourceByName("Gold"), 2000);
                p.SetResourceCount(ObjectManager.DataTables.GetResourceByName("Elixir"), 2000);
                p.SetResourceCount(ObjectManager.DataTables.GetResourceByName("DarkElixir"), 0);
                p.SetDiamonds(1500);
